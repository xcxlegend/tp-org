...
class upmp_config
{
    ...
    static $mer_id                  = "898111148160414"; // 商户号
    static $security_key            = "KkdtGOB9HD3cbFS7RiZuHVsof1fKhGNu"; // 商户密钥
    //static $mer_back_end_url        = "http://account.ilongyuan.cn/Oauth/Pay/notify/paymethod/upmp";
    //"http://www.yourdomain.com/your_path/yourBackEndUrl"; // 后台通知地址
    //static $mer_front_end_url       = "http://account.ilongyuan.cn/Oauth/Pay/return_notify/paymethod/upmp";
    //"http://www.yourdomain.com/your_path/yourFrontEndUrl"; // 前台通知地址

    static $upmp_trade_url          = "https://mgate.unionpay.com/gateway/merchant/trade";//"http://202.101.25.178:8080/gateway/merchant/trade";
    static $upmp_query_url          = "https://mgate.unionpay.com/gateway/merchant/query";//"http://202.101.25.178:8080/gateway/merchant/query";  
